...
!  endif
  ...
  elseif (CS%embedded_ice_ocn) then
    ...
    do ns=1,nstep
      ...
      call direct_flux_ice_to_IOB(time_start_step, Ice, IOB, do_embed=CS%embedded_ice_ocn)
...
subroutine direct_flux_ice_to_IOB(Time, Ice, IOB, do_thermo, do_embed)
